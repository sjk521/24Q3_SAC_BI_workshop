...
const metricIconMap = {
    ...
    class MetricPlotareaComponent extends HTMLElement {
        ...
        renderNumber(num) {
            ...
            if(this._customUnit) {
                let resultValue = (pointValue / this._customUnitNum).toFixed(2);
                ...
                numLabelEl.textContent = `${resultValue} ${this._customUnitName}`;
            } else
    ...
    customElements.define('viz-metric-plotarea-en', MetricPlotareaComponent);
